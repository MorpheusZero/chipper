...
import (
	...
	"github.com/morpheuszero/chipper/config"
	"github.com/morpheuszero/chipper/internal/beeper"
...
func main() {
	...
	chipperConfig := config.ChipperConfig{}.InitConfig()

	if chipperConfig.DEBUG {
		log.Println("###########################")
		log.Println("[CHIPPER] DEBUG IS ENABLED!")
		log.Println("###########################")
		log.Println("")
	}
	...
	// Setup CPU
	chipperCPUOptions := cpu.CPUOptions{
		MAX_RAM_MEMORY_SIZE: chipperConfig.MAX_RAM_MEMORY_SIZE,
		MAX_STACK_SIZE:      chipperConfig.MAX_STACK_SIZE,
	}
	c8 := cpu.CPU{}.InitCPU(chipperCPUOptions)
